    ...
    for img_id in img_ids:
        ...
        for elem in root:  # root.tag = Annotation
            if elem.tag == "filename":  # get picture name
                ...
                testimg_width[img_id] = width;
                testimg_height[img_id] = height;

    return testimg_width,testimg_height
if __name__ == '__main__':
    ...
    if 1:
        ...
        testimg_width,testimg_height=parseXmlFiles(ann_file, img_prefix, patch_path)
    if 0:
    ...
    save_dict('dict_output/testimg_width',testimg_width)
    save_dict('dict_output/testimg_height',testimg_height)
